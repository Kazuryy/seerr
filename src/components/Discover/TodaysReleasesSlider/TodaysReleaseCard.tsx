...
interface TodaysReleaseCardProps {
  item: CalendarItem;
}

const TodaysReleaseCard: React.FC<TodaysReleaseCardProps> = ({ item }) => {
  const intl = useIntl();
      ...
      <Link href={url}>
        <a>
          ...
          >
            ...
            <div className="relative aspect-video w-full overflow-hidden bg-gray-900">
              ...
              {item.hasFile && (
                <div className="absolute bottom-2 right-2 z-40">
                  <div className="rounded-full bg-green-600 bg-opacity-90 px-2 py-1 text-xs font-semibold text-white shadow-md">
                    Available
                  </div>
                </div>
              )}
            ...
            <div className="p-3">
              {/* Title */}
              <h3 className="line-clamp-2 mb-1 text-sm font-bold text-white">
                {item.title}
              </h3>
...
export default TodaysReleaseCard;
