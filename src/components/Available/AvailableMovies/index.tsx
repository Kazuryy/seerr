...
const messages = defineMessages('components.Available.AvailableMovies', {
  availablemovies: 'Available Movies',
  sortPopularityDesc: 'Popularity',
  sortReleaseDateDesc: 'Release Date',
...
const AvailableMovies = () => {
  ...
  const {
    ...
    fetchMore,
    error,
  } = useDiscover<MovieResult>('/api/v1/available/movies', router.query);

  if (error) {
    return <Error statusCode={500} />;
  }

  const title = intl.formatMessage(messages.availablemovies);
        ...
        <div className="mt-2 flex flex-grow flex-col sm:flex-row lg:flex-grow-0">
          <div className="mb-2 flex flex-grow sm:mb-0 sm:mr-2 lg:flex-grow-0">
            ...
            >
              ...
              <option value={SortOptions.ReleaseDate}>
